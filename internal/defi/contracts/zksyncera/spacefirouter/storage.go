...
// Pairtest is a paid mutator transaction binding the contract method 0xf493e284.
//
// Solidity: function pairtest(address pair, address to) returns(uint256 liquidity)
func (_Storage *StorageTransactor) Pairtest(opts *bind.TransactOpts, pair common.Address, to common.Address) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "pairtest", pair, to)
}

// Pairtest is a paid mutator transaction binding the contract method 0xf493e284.
//
// Solidity: function pairtest(address pair, address to) returns(uint256 liquidity)
func (_Storage *StorageSession) Pairtest(pair common.Address, to common.Address) (*types.Transaction, error) {
	return _Storage.Contract.Pairtest(&_Storage.TransactOpts, pair, to)
}

// Pairtest is a paid mutator transaction binding the contract method 0xf493e284.
//
// Solidity: function pairtest(address pair, address to) returns(uint256 liquidity)
func (_Storage *StorageTransactorSession) Pairtest(pair common.Address, to common.Address) (*types.Transaction, error) {
	return _Storage.Contract.Pairtest(&_Storage.TransactOpts, pair, to)
}
...
// RemoveLiquidityETHWithPermit2 is a paid mutator transaction binding the contract method 0x36174ddb.
//
// Solidity: function removeLiquidityETHWithPermit2(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountToken, uint256 amountETH)
func (_Storage *StorageTransactor) RemoveLiquidityETHWithPermit2(opts *bind.TransactOpts, token common.Address, liquidity *big.Int, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "removeLiquidityETHWithPermit2", token, liquidity, amountTokenMin, amountETHMin, to, deadline, approveMax, signature)
}

// RemoveLiquidityETHWithPermit2 is a paid mutator transaction binding the contract method 0x36174ddb.
//
// Solidity: function removeLiquidityETHWithPermit2(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountToken, uint256 amountETH)
func (_Storage *StorageSession) RemoveLiquidityETHWithPermit2(token common.Address, liquidity *big.Int, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.Contract.RemoveLiquidityETHWithPermit2(&_Storage.TransactOpts, token, liquidity, amountTokenMin, amountETHMin, to, deadline, approveMax, signature)
}

// RemoveLiquidityETHWithPermit2 is a paid mutator transaction binding the contract method 0x36174ddb.
//
// Solidity: function removeLiquidityETHWithPermit2(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountToken, uint256 amountETH)
func (_Storage *StorageTransactorSession) RemoveLiquidityETHWithPermit2(token common.Address, liquidity *big.Int, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.Contract.RemoveLiquidityETHWithPermit2(&_Storage.TransactOpts, token, liquidity, amountTokenMin, amountETHMin, to, deadline, approveMax, signature)
}
...
// RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2 is a paid mutator transaction binding the contract method 0x4f5d258f.
//
// Solidity: function removeLiquidityETHWithPermitSupportingFeeOnTransferTokens2(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountETH)
func (_Storage *StorageTransactor) RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2(opts *bind.TransactOpts, token common.Address, liquidity *big.Int, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "removeLiquidityETHWithPermitSupportingFeeOnTransferTokens2", token, liquidity, amountTokenMin, amountETHMin, to, deadline, approveMax, signature)
}

// RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2 is a paid mutator transaction binding the contract method 0x4f5d258f.
//
// Solidity: function removeLiquidityETHWithPermitSupportingFeeOnTransferTokens2(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountETH)
func (_Storage *StorageSession) RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2(token common.Address, liquidity *big.Int, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.Contract.RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2(&_Storage.TransactOpts, token, liquidity, amountTokenMin, amountETHMin, to, deadline, approveMax, signature)
}

// RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2 is a paid mutator transaction binding the contract method 0x4f5d258f.
//
// Solidity: function removeLiquidityETHWithPermitSupportingFeeOnTransferTokens2(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountETH)
func (_Storage *StorageTransactorSession) RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2(token common.Address, liquidity *big.Int, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.Contract.RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens2(&_Storage.TransactOpts, token, liquidity, amountTokenMin, amountETHMin, to, deadline, approveMax, signature)
}
...
// RemoveLiquidityWithPermit2 is a paid mutator transaction binding the contract method 0xee03387a.
//
// Solidity: function removeLiquidityWithPermit2(address tokenA, address tokenB, uint256 liquidity, uint256 amountAMin, uint256 amountBMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountA, uint256 amountB)
func (_Storage *StorageTransactor) RemoveLiquidityWithPermit2(opts *bind.TransactOpts, tokenA common.Address, tokenB common.Address, liquidity *big.Int, amountAMin *big.Int, amountBMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "removeLiquidityWithPermit2", tokenA, tokenB, liquidity, amountAMin, amountBMin, to, deadline, approveMax, signature)
}

// RemoveLiquidityWithPermit2 is a paid mutator transaction binding the contract method 0xee03387a.
//
// Solidity: function removeLiquidityWithPermit2(address tokenA, address tokenB, uint256 liquidity, uint256 amountAMin, uint256 amountBMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountA, uint256 amountB)
func (_Storage *StorageSession) RemoveLiquidityWithPermit2(tokenA common.Address, tokenB common.Address, liquidity *big.Int, amountAMin *big.Int, amountBMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.Contract.RemoveLiquidityWithPermit2(&_Storage.TransactOpts, tokenA, tokenB, liquidity, amountAMin, amountBMin, to, deadline, approveMax, signature)
}

// RemoveLiquidityWithPermit2 is a paid mutator transaction binding the contract method 0xee03387a.
//
// Solidity: function removeLiquidityWithPermit2(address tokenA, address tokenB, uint256 liquidity, uint256 amountAMin, uint256 amountBMin, address to, uint256 deadline, bool approveMax, bytes signature) returns(uint256 amountA, uint256 amountB)
func (_Storage *StorageTransactorSession) RemoveLiquidityWithPermit2(tokenA common.Address, tokenB common.Address, liquidity *big.Int, amountAMin *big.Int, amountBMin *big.Int, to common.Address, deadline *big.Int, approveMax bool, signature []byte) (*types.Transaction, error) {
	return _Storage.Contract.RemoveLiquidityWithPermit2(&_Storage.TransactOpts, tokenA, tokenB, liquidity, amountAMin, amountBMin, to, deadline, approveMax, signature)
}
