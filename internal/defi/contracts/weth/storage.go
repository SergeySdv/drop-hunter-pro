...
func (_Storage *StorageCaller) L2Gateway(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "l2Gateway")
...
//
// Solidity: function l2Gateway() view returns(address)
func (_Storage *StorageSession) L2Gateway() (common.Address, error) {
	return _Storage.Contract.L2Gateway(&_Storage.CallOpts)
}

// L2Gateway is a free data retrieval call binding the contract method 0x8fa74a0e.
//
// Solidity: function l2Gateway() view returns(address)
func (_Storage *StorageCallerSession) L2Gateway() (common.Address, error) {
	return _Storage.Contract.L2Gateway(&_Storage.CallOpts)
}
...
func (_Storage *StorageTransactor) BridgeBurn(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "bridgeBurn", account, amount)
}

// BridgeBurn is a paid mutator transaction binding the contract method 0x74f4f547.
//
// Solidity: function bridgeBurn(address account, uint256 amount) returns()
func (_Storage *StorageSession) BridgeBurn(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.BridgeBurn(&_Storage.TransactOpts, account, amount)
}

// BridgeBurn is a paid mutator transaction binding the contract method 0x74f4f547.
//
// Solidity: function bridgeBurn(address account, uint256 amount) returns()
func (_Storage *StorageTransactorSession) BridgeBurn(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.BridgeBurn(&_Storage.TransactOpts, account, amount)
}
...
func (_Storage *StorageTransactor) BridgeMint(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "bridgeMint", account, amount)
}

// BridgeMint is a paid mutator transaction binding the contract method 0x8c2a993e.
//
// Solidity: function bridgeMint(address account, uint256 amount) returns()
func (_Storage *StorageSession) BridgeMint(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.BridgeMint(&_Storage.TransactOpts, account, amount)
}

// BridgeMint is a paid mutator transaction binding the contract method 0x8c2a993e.
//
// Solidity: function bridgeMint(address account, uint256 amount) returns()
func (_Storage *StorageTransactorSession) BridgeMint(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.BridgeMint(&_Storage.TransactOpts, account, amount)
}
...
func (_Storage *StorageTransactor) DepositTo(opts *bind.TransactOpts, account common.Address) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "depositTo", account)
}

// DepositTo is a paid mutator transaction binding the contract method 0xb760faf9.
//
// Solidity: function depositTo(address account) payable returns()
func (_Storage *StorageSession) DepositTo(account common.Address) (*types.Transaction, error) {
	return _Storage.Contract.DepositTo(&_Storage.TransactOpts, account)
}

// DepositTo is a paid mutator transaction binding the contract method 0xb760faf9.
//
// Solidity: function depositTo(address account) payable returns()
func (_Storage *StorageTransactorSession) DepositTo(account common.Address) (*types.Transaction, error) {
	return _Storage.Contract.DepositTo(&_Storage.TransactOpts, account)
}
...
//
// Solidity: function initialize(string _name, string _symbol, uint8 _decimals, address _l2Gateway, address _l1Address) returns()
func (_Storage *StorageTransactor) Initialize(opts *bind.TransactOpts, _name string, _symbol string, _decimals uint8, _l2Gateway common.Address, _l1Address common.Address) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "initialize", _name, _symbol, _decimals, _l2Gateway, _l1Address)
}

// Initialize is a paid mutator transaction binding the contract method 0xc820f146.
//
// Solidity: function initialize(string _name, string _symbol, uint8 _decimals, address _l2Gateway, address _l1Address) returns()
func (_Storage *StorageSession) Initialize(_name string, _symbol string, _decimals uint8, _l2Gateway common.Address, _l1Address common.Address) (*types.Transaction, error) {
	return _Storage.Contract.Initialize(&_Storage.TransactOpts, _name, _symbol, _decimals, _l2Gateway, _l1Address)
}

// Initialize is a paid mutator transaction binding the contract method 0xc820f146.
//
// Solidity: function initialize(string _name, string _symbol, uint8 _decimals, address _l2Gateway, address _l1Address) returns()
func (_Storage *StorageTransactorSession) Initialize(_name string, _symbol string, _decimals uint8, _l2Gateway common.Address, _l1Address common.Address) (*types.Transaction, error) {
	return _Storage.Contract.Initialize(&_Storage.TransactOpts, _name, _symbol, _decimals, _l2Gateway, _l1Address)
}
...
func (_Storage *StorageTransactor) TransferAndCall(opts *bind.TransactOpts, _to common.Address, _value *big.Int, _data []byte) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "transferAndCall", _to, _value, _data)
}

// TransferAndCall is a paid mutator transaction binding the contract method 0x4000aea0.
//
// Solidity: function transferAndCall(address _to, uint256 _value, bytes _data) returns(bool success)
func (_Storage *StorageSession) TransferAndCall(_to common.Address, _value *big.Int, _data []byte) (*types.Transaction, error) {
	return _Storage.Contract.TransferAndCall(&_Storage.TransactOpts, _to, _value, _data)
}

// TransferAndCall is a paid mutator transaction binding the contract method 0x4000aea0.
//
// Solidity: function transferAndCall(address _to, uint256 _value, bytes _data) returns(bool success)
func (_Storage *StorageTransactorSession) TransferAndCall(_to common.Address, _value *big.Int, _data []byte) (*types.Transaction, error) {
	return _Storage.Contract.TransferAndCall(&_Storage.TransactOpts, _to, _value, _data)
}
...
func (_Storage *StorageTransactor) Withdraw(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "withdraw", amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 amount) returns()
func (_Storage *StorageSession) Withdraw(amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.Withdraw(&_Storage.TransactOpts, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 amount) returns()
func (_Storage *StorageTransactorSession) Withdraw(amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.Withdraw(&_Storage.TransactOpts, amount)
}

// WithdrawTo is a paid mutator transaction binding the contract method 0x205c2878.
//
// Solidity: function withdrawTo(address account, uint256 amount) returns()
func (_Storage *StorageTransactor) WithdrawTo(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "withdrawTo", account, amount)
}

// WithdrawTo is a paid mutator transaction binding the contract method 0x205c2878.
//
// Solidity: function withdrawTo(address account, uint256 amount) returns()
func (_Storage *StorageSession) WithdrawTo(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.WithdrawTo(&_Storage.TransactOpts, account, amount)
}

// WithdrawTo is a paid mutator transaction binding the contract method 0x205c2878.
//
// Solidity: function withdrawTo(address account, uint256 amount) returns()
func (_Storage *StorageTransactorSession) WithdrawTo(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.WithdrawTo(&_Storage.TransactOpts, account, amount)
}
...
// StorageTransfer0Iterator is returned from FilterTransfer0 and is used to iterate over the raw logs and unpacked data for Transfer0 events raised by the Storage contract.
type StorageTransfer0Iterator struct {
	Event *StorageTransfer0 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StorageTransfer0Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StorageTransfer0Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StorageTransfer0Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StorageTransfer0 represents a Transfer0 event raised by the Storage contract.
type StorageTransfer0 struct {
	From  common.Address
	To    common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
func (_Storage *StorageFilterer) FilterTransfer0(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*StorageTransfer0Iterator, error) {
	...
	logs, sub, err := _Storage.contract.FilterLogs(opts, "Transfer0", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &StorageTransfer0Iterator{contract: _Storage.contract, event: "Transfer0", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_Storage *StorageFilterer) WatchTransfer0(opts *bind.WatchOpts, sink chan<- *StorageTransfer0, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Storage.contract.WatchLogs(opts, "Transfer0", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StorageTransfer0)
				if err := _Storage.contract.UnpackLog(event, "Transfer0", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_Storage *StorageFilterer) ParseTransfer0(log types.Log) (*StorageTransfer0, error) {
	event := new(StorageTransfer0)
	if err := _Storage.contract.UnpackLog(event, "Transfer0", log); err != nil {
		return nil, err
	}
