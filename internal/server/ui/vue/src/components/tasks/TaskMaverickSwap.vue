<template>
  <v-card-actions>
    <v-container>
      <div class="mb-3">use <a :href="link.Maverick" target="_blank">Maverick</a> to see
        available swap
        options
      </div>
      <v-row>
...
<script lang="ts">
import {MaverickSwapTask, Network, Task, TaskType, Token} from "@/generated/flow";
