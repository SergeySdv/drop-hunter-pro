<template>
  <a :href="taskProps.VeSyncSwap.service.link" target="_blank">{{ taskProps.VeSyncSwap.service.name }}</a>
...
import {
  ...
  TaskType,
  Token,
  VelocoreSwapTask, VeSyncSwapTask
} from "@/generated/flow";
