<template>
  <a :href="link.Maverick" target="_blank">Maverick</a>
...
<script lang="ts">
import {AmUni, MaverickSwapTask, Network, SyncSwapTask, Task, TaskType, Token} from "@/generated/flow";
