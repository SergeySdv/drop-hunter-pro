<template>
  <v-card-actions>
    <v-container>
      <div class="mb-3">use<a :href="taskProps.VelocoreSwap.service.link"
                              target="_blank">{{ taskProps.VelocoreSwap.service.name }}</a> to see
        available swap
        options
      </div>
      <v-row>
...
<script lang="ts">
import {MaverickSwapTask, Network, SpaceFiSwapTask, Task, TaskType, Token, VelocoreSwapTask} from "@/generated/flow";
