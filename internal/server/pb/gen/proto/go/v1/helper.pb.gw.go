...
func RegisterHelperServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HelperServiceServer) error {
	...
	mux.Handle("POST", pattern_HelperService_EstimateStargateBridgeFee_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helper.HelperService/EstimateStargateBridgeFee", runtime.WithHTTPPathPattern("/api/gw/api/v1/helper/stargate-bridge-fee/estimate"))
		if err != nil {
	...
	mux.Handle("POST", pattern_HelperService_ValidatePK_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helper.HelperService/ValidatePK", runtime.WithHTTPPathPattern("/api/gw/api/v1/helper/validatePK"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HelperService_ValidateProxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helper.HelperService/ValidateProxy", runtime.WithHTTPPathPattern("/api/gw/api/v1/helper/validateProxy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterHelperServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelperServiceClient) error {
	...
	mux.Handle("POST", pattern_HelperService_EstimateStargateBridgeFee_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helper.HelperService/EstimateStargateBridgeFee", runtime.WithHTTPPathPattern("/api/gw/api/v1/helper/stargate-bridge-fee/estimate"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HelperService_ValidatePK_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helper.HelperService/ValidatePK", runtime.WithHTTPPathPattern("/api/gw/api/v1/helper/validatePK"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HelperService_ValidateProxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helper.HelperService/ValidateProxy", runtime.WithHTTPPathPattern("/api/gw/api/v1/helper/validateProxy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_HelperService_EstimateStargateBridgeFee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "gw", "v1", "helper", "stargate-bridge-fee", "estimate"}, ""))

	pattern_HelperService_ValidatePK_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4}, []string{"api", "gw", "v1", "helper", "validatePK"}, ""))

	pattern_HelperService_ValidateProxy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4}, []string{"api", "gw", "v1", "helper", "validateProxy"}, ""))
)
