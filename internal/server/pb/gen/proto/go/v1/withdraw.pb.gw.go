...
func RegisterWithdrawerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WithdrawerServiceServer) error {
	...
	mux.Handle("POST", pattern_WithdrawerService_CreateWithdrawer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/withdrawer.WithdrawerService/CreateWithdrawer", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/add"))
		if err != nil {
	...
	mux.Handle("POST", pattern_WithdrawerService_ListWithdrawer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/withdrawer.WithdrawerService/ListWithdrawer", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_WithdrawerService_DeleteWithdrawer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/withdrawer.WithdrawerService/DeleteWithdrawer", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/delete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_WithdrawerService_GetExchangeWithdrawOptions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/withdrawer.WithdrawerService/GetExchangeWithdrawOptions", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/exchange/options"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterWithdrawerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WithdrawerServiceClient) error {
	...
	mux.Handle("POST", pattern_WithdrawerService_CreateWithdrawer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/withdrawer.WithdrawerService/CreateWithdrawer", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/add"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_WithdrawerService_ListWithdrawer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/withdrawer.WithdrawerService/ListWithdrawer", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_WithdrawerService_DeleteWithdrawer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/withdrawer.WithdrawerService/DeleteWithdrawer", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/delete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_WithdrawerService_GetExchangeWithdrawOptions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/withdrawer.WithdrawerService/GetExchangeWithdrawOptions", runtime.WithHTTPPathPattern("/api/gw/api/v1/withdrawer/exchange/options"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_WithdrawerService_CreateWithdrawer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4}, []string{"api", "gw", "v1", "withdrawer", "add"}, ""))

	pattern_WithdrawerService_ListWithdrawer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4}, []string{"api", "gw", "v1", "withdrawer", "list"}, ""))

	pattern_WithdrawerService_DeleteWithdrawer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4}, []string{"api", "gw", "v1", "withdrawer", "delete"}, ""))

	pattern_WithdrawerService_GetExchangeWithdrawOptions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 0, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "gw", "v1", "withdrawer", "exchange", "options"}, ""))
)
