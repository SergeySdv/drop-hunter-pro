...
func (t *VeSyncSwapTask) Stop() error {
	t.cancel()
	return nil
}

func (t *VeSyncSwapTask) Reset(ctx context.Context, a *Input) error {
	task := a.Task
...
func (t *VeSyncSwapTask) Run(ctx context.Context, a *Input) (*v1.ProcessTask, error) {
	...
	if !ok {
		return nil, errors.New("panic.a.Task.Task.Task.(*v1.Task_VeSyncSwapTask) call an ambulance!")
	}
...
func VeSyncSwap(ctx context.Context, profile *halp.Profile, p *v1.VeSyncSwapTask, client zksyncera.VeSyncSwapper, estimation *v1.EstimationTx) (*defi.DefaultSwapRes, *defi.Gas, error) {
	...
	res, err := client.VeSyncSwap(ctx, &defi.DefaultSwapReq{
...
func EstimateVeSyncSwapCost(ctx context.Context, profile *halp.Profile, p *v1.VeSyncSwapTask, client zksyncera.VeSyncSwapper) (*v1.EstimationTx, error) {
	res, _, err := VeSyncSwap(ctx, profile, p, client, nil)
	if err != nil {
		return nil, err
	}
